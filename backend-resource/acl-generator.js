...
function ruleGenerator ( aclObject, geneInfo, ruleNumber=25, rangeSize=2 ) {
	...
	function ruleDevelop( policy, ruleNumber, callback ) {
		...
		function ipRandomization ( ipData ) {
			...
			newAddr = ipConvertor((newAddrValue & newMaskValue)>>>0);
